...
class Controls extends FlxActionSet
{
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		{
			case Solo:
				inline bindKeys(Control.UP, [J, FlxKey.UP, N, O]);
				inline bindKeys(Control.DOWN, [F, FlxKey.DOWN, X, W]);
				inline bindKeys(Control.LEFT, [D, FlxKey.LEFT, Q, Z]);
				inline bindKeys(Control.RIGHT, [K, FlxKey.RIGHT, M, P]);
				inline bindKeys(Control.ACCEPT, [SPACE, ENTER]);
				inline bindKeys(Control.BACK, [BACKSPACE, ESCAPE]);
				inline bindKeys(Control.PAUSE, [ENTER, ESCAPE]);
				inline bindKeys(Control.RESET, [R]);
				inline bindKeys(Control.CHEAT, [FIVE]);
			case Duo(true):
				inline bindKeys(Control.UP, [W, FlxKey.UP, I]);
				inline bindKeys(Control.DOWN, [S, FlxKey.DOWN, K]);
				inline bindKeys(Control.LEFT, [A, FlxKey.LEFT, J]);
				inline bindKeys(Control.RIGHT, [D, FlxKey.RIGHT, L]);
				inline bindKeys(Control.ACCEPT, [G, Z, SPACE, ENTER]);
				inline bindKeys(Control.BACK, [BACKSPACE, ESCAPE]);
				inline bindKeys(Control.PAUSE, [ENTER, ESCAPE]);
				inline bindKeys(Control.RESET, [R]);
				inline bindKeys(Control.CHEAT, [Q]);
			case Duo(false):
		...
		{
			case Solo:
				bindKeys(Control.UP, [J, FlxKey.UP, N, O]);
				bindKeys(Control.DOWN, [F, FlxKey.DOWN, X, W]);
				bindKeys(Control.LEFT, [D, FlxKey.LEFT, Q, Z]);
				bindKeys(Control.RIGHT, [K, FlxKey.RIGHT, M, P]);
				bindKeys(Control.ACCEPT, [SPACE, ENTER]);
				bindKeys(Control.BACK, [BACKSPACE, ESCAPE]);
				bindKeys(Control.PAUSE, [ENTER, ESCAPE]);
				bindKeys(Control.RESET, [R]);
				bindKeys(Control.CHEAT, [FIVE]);
			case Duo(true):
				bindKeys(Control.UP, [W, FlxKey.UP, I]);
				bindKeys(Control.DOWN, [S, FlxKey.DOWN, K]);
				bindKeys(Control.LEFT, [A, FlxKey.LEFT, J]);
				bindKeys(Control.RIGHT, [D, FlxKey.RIGHT, L]);
				bindKeys(Control.ACCEPT, [G, Z, SPACE, ENTER]);
				bindKeys(Control.BACK, [BACKSPACE, ESCAPE]);
				bindKeys(Control.RESET, [R]);
				bindKeys(Control.CHEAT, [Q]);
			case Duo(false):
