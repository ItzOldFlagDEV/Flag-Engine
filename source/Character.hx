...
class Character extends FlxSprite
{
	...
	public static var opponentColor:FlxColor;
	public static var playerColor:FlxColor;
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playerColor = 0xFF9152C5;
				opponentColor = 0xFF9152C5;
			case 'spooky':
